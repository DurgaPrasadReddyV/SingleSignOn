...
using SingleSignOn.AuthServer.MVC.ViewModels.Consent;
using SingleSignOn.AuthServer.MVC.ViewModels.Device;

namespace SingleSignOn.AuthServer.MVC.Controllers
{
    [Authorize]
    [SecurityHeaders]
