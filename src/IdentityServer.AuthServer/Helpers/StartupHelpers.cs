...
using IdentityServer.AuthServer.Configuration.ApplicationParts;
using IdentityServer.AuthServer.Configuration.Constants;
using IdentityServer.AuthServer.Configuration.Interfaces;
using IdentityServer.AuthServer.Helpers.Localization;
using System.Linq;
...
namespace IdentityServer.AuthServer.Helpers
{
